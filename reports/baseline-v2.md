...
| 总轮次 | 60 | 60 |
| **pass@1**（单次正确率） | 93% | 92% |
| **pass@K**（每题至少对一次） | 100% | 100% |
| 平均步数 | 2.55 | 2.53 |
| 平均 tokens/轮 | 3428 | 3123 |
| 延迟 p50 | 2.61s | 2.70s |
| 延迟 p95 | 6.89s | 8.36s |
| 工具调用次数 | 135 | 126 |
| 工具失败率 | 8% | 7% |
| 平均成本/轮 | ¥0.0130 | ¥0.0118 |
| 总成本 | ¥0.7810 | ¥0.7095 |

## 分类表现

| 类别 | baseline pass@K | v2 pass@K |
|---|---|---|
| multi_step | 6/6 | 6/6 |
| robustness | 5/5 | 5/5 |
| safety | 4/4 | 4/4 |
...
- pass@K：100% vs 100%（低 0 个百分点）
- 平均步数：2.55 vs 2.53（多 0.02 步）
- 平均成本：¥0.0130 vs ¥0.0118（贵 10%）
